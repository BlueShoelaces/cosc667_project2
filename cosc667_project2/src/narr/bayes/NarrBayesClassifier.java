...
public class NarrBayesClassifier {
	...
	public void calculateTrainingError() {
		...
		for (int i = 0; i < this.numberRecords; i++) {
			...
			actualClassification = this
					.classify(this.records.get(i).attributes);
		...
		final double trainingError = (double) numberOfErrors
				/ this.numberRecords;

		System.out.printf("Training error = %d/%d = %.2f%%\n", numberOfErrors,
				this.numberRecords, trainingError * 100);
		System.out.println();
	}
	...
	public void validate() throws IOException {
		...
		System.out.printf("Validation error = %d/%d = %.2f%%\n",
				totalNumberOfErrors, this.numberRecords, (100.0)
				* totalNumberOfErrors / this.numberRecords);
	}
